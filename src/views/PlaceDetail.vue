...
const tips = {
  أثري: [
    ...
    'خدي معاكي مياه وحاجة تحميكي من الشمس',
    'ممكن تحجزي جولة بمرشد سياحي عشان تعرفي تفاصيل أكتر',
  ],

  ديني: [
    'الزي المحتشم مطلوب عند الدخول',
    'احترمي مواعيد الصلاة لو زرتي وقت الأذان',
    'اسألي عن قواعد التصوير قبل ما تبدئي',
  ],

  معماري: [
    'وقت الغروب بيدي إضاءة جميلة للتصوير',
    'ممكن تستفيدي من الجولات اللي بتشرح تفاصيل المكان',
  ],

  متحف: [
    'خدي وقت كفاية عشان تشوفي المكان بشكل كويس',
...
onMounted(async () => {
  try {
    // رحمة: بنجيب رقم المكان من الرابط
    const id = route.params.id

    // رحمة: بنجيب بيانات المكان من السيرفر
    ...
    // رحمة: بنجيب النصايح حسب نوع المكان
